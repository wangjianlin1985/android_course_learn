...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_title.setText("视频资料标题：" + mData.get(position).get("title").toString());
	  holder.tv_chapterId.setText("所属章：" + (new ChapterService()).GetChapter(Integer.parseInt(mData.get(position).get("chapterId").toString())).getTitle());
	  holder.tv_path.setText("文件路径：" + mData.get(position).get("path").toString());
