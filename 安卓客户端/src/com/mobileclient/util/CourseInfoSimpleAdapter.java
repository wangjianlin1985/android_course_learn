...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_dagan = (TextView)convertView.findViewById(R.id.tv_dagan);
	  /*设置各个控件的展示内容*/
	  holder.tv_jianjie.setText("课程简介：" + mData.get(position).get("jianjie").toString());
	  holder.tv_dagan.setText("课程大纲：" + mData.get(position).get("dagan").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
