...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_chapterId = (TextView)convertView.findViewById(R.id.tv_chapterId);
	  ...
	  holder.tv_title.setText("习题名称：" + mData.get(position).get("title").toString());
	  holder.tv_chapterId.setText("所在章：" + (new ChapterService()).GetChapter(Integer.parseInt(mData.get(position).get("chapterId").toString())).getTitle());
	  holder.tv_addTime.setText("加入时间：" + mData.get(position).get("addTime").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
