...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"课件信息","章信息","视频信息","习题信息","在线问答","作业任务","上传的作业","修改个人信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, ChapterListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, VideoListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
					Intent intent  = new Intent(MoreActivity.this, ExerciseListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 4){
					Intent intent  = new Intent(MoreActivity.this, QuestionListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 5){
					Intent intent  = new Intent(MoreActivity.this, HomeworkTaskListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 6){
					Intent intent  = new Intent(MoreActivity.this, HomeworkUploadListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 7){
