			...
			public void onClick(View v) {
				try {
					...
					if(ET_title.getText().toString().equals("")) {
						Toast.makeText(ExerciseAddActivity.this, "习题名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(ExerciseAddActivity.this, "练习内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(ExerciseAddActivity.this, "加入时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传习题信息信息*/
					ExerciseAddActivity.this.setTitle("正在上传习题信息信息，稍等...");
