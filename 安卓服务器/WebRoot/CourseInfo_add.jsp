...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>课程简介:</td>
    <td width=70%><textarea id="courseInfo.jianjie" name="courseInfo.jianjie" rows="5" cols="50"></textarea></td>
  </tr>

  <tr>
    <td width=30%>课程大纲:</td>
    <td width=70%><textarea id="courseInfo.dagan" name="courseInfo.dagan" rows="5" cols="50"></textarea></td>
  </tr>
